...
String sta_ssid = "Surya";      // set Wifi networks you want to connect to
String sta_password = "Surya";  // set password for Wifi networks
...
void loop() {
    ...
    server.handleClient();        // listen for HTTP requests from clients
      ...
      if (command == "F") Backward();          // check string then call a function or set a value
      else if (command == "B") Forward();
      else if (command == "R") TurnLeft();
      else if (command == "L") TurnRight();
